                        ...
                        <table id="zero_config" class="table border table-striped table-bordered text-nowrap">
                            ...
                            @foreach($categories as $index => $category)
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>{{ $category->name }}</td>
                                    <td>
                                        <a href="{{ route('category.edit', $category) }}" role="button"
                                           class="btn waves-effect waves-light btn-sm btn-rounded btn-success"><i
                                                class="fas fa-pencil-alt"></i> Edit</a>
                                        <form action="{{ route('category.delete', $category) }}" method="post" style="display: initial">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <a href="{{ route('category.courses', $category) }}" role="button"
