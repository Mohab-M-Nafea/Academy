                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="name"
                                                       placeholder="Course Name" value="{{ old('name') }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control custom-select" name="teacher"
                                                    ...
                                                    @foreach($teachers as $teacher)
                                                        <option
                                                            value="{{ $teacher->id }}"
                                                            @if(old('teacher') === $teacher->id) selected @endif>{{ $teacher->first_name }} {{ $teacher->last_name }}</option>
                                                    @endforeach
